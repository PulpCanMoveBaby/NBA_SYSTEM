# Overview
Using statistical analysis and data from past NBA games over the course of the 2025-26 season, I have developed a system for giving each team a score based off of the past n-games.
...
After many adjustments made to the scoring sytem, I have been able to improve those numbers significantly. 

I have implemented reinforcement learning as the contribution of each parameter to the overall score has been weighted based off of its own performance. 
